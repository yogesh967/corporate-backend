...
<body>
	...
	<main role="main">
		<div class="container" align="center">
			<div class="jumbotron" id="content">
					<h1 class="display-6">Search Offer By Date</h1>
			</div>


			<div class="col-md-4" id="profile">
				<form name="offerDate" action="viewofferbydate" onsubmit="return validateForm()">
					<div>
						<input type="date" id="offByPostedDate" name="offByPostedDate"
							value="Posted Date" required></input>
					</div>
					<div id="offerbutton">
						<button class="btn btn-primary btn-lg">View Offer &raquo</button>
					</div>
			</div>
	</main>
	...
	<script>
		function validateForm() {
			var openedDate = document.getElementById("offByPostedDate").value;
			var currentDate = new Date();
			openedDate = new Date(openedDate);
			if (openedDate > currentDate) {
				alert(" Select Posted date within today's date");
				return false;
			}
