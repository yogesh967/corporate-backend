...
<body>
	...
	<main role="main">
<div>
						<h1 class="display-3">${offerempty}</h1>
					</div>
		<div class="jumbotron" id="content">
			<div class="container">
				<h1 class="display-3">Hello, ${name}!</h1>
				<div id="offerbutton">
					<a class="btn btn-primary btn-lg" href="addOffer" role="button">Click
						to Add yours &raquo;</a>
				</div>
			</div>
		</div>
			  <section class="subscribe">
				...
				<c:if test="${offlist !=null}">
					<c:forEach items="${offlist}" var="offer">
